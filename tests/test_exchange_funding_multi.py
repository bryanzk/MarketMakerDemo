...
class TestFetchFundingRateForSymbol:
    ...
    def test_fetch_funding_rate_for_symbol_success(self, mock_exchange):
        ...
        mock_exchange.exchange.fapiPublicGetPremiumIndex.assert_called_once_with({'symbol': 'BTCUSDT'})
    ...
    def test_fetch_funding_rate_api_error(self, mock_exchange):
        ...
        mock_exchange.exchange.fapiPublicGetPremiumIndex.side_effect = Exception("API Error")
...
class TestFetchBulkFundingRates:
    ...
    def test_fetch_bulk_funding_rates_success(self, mock_exchange):
        ...
        mock_exchange.exchange.fapiPublicGetPremiumIndex.return_value = [
            {'symbol': 'BTCUSDT', 'predictedFundingRate': '0.0001', 'lastFundingRate': '0.00009'},
            {'symbol': 'ETHUSDT', 'predictedFundingRate': '0.00015', 'lastFundingRate': '0.00012'},
            {'symbol': 'SOLUSDT', 'predictedFundingRate': None, 'lastFundingRate': '0.0002'},
        ]
