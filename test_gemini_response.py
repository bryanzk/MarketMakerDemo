#!/usr/bin/env python3
"""
Test Gemini Response / 测试 Gemini 响应

Display raw response from Gemini to debug evaluation issues
显示 Gemini 的原始响应以调试评估问题
"""
...
def main():
    """Main function to test Gemini response"""
    print("=" * 80)
    print("Gemini Response Test / Gemini 响应测试")
    print("=" * 80)
    print()
    ...
    try:
        ...
        print(f"✅ Gemini provider initialized: {provider.name}")
        print()
    ...
    try:
        ...
        print(f"✅ Received response (length: {len(raw_response) if raw_response else 0} characters)")
        print()
        print("=" * 80)
