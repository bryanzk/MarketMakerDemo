"""
Exchange Metrics Module / 交易所指标模块
...
Note: This module is separate from src/shared/metrics/ which handles
      strategy evaluation metrics. This module focuses on exchange
      operation observability.
注意：此模块与处理策略评估指标的 src/shared/metrics/ 分开。
      此模块专注于交易所操作可观测性。
"""
